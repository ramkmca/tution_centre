...
$query_user_list="SELECT * FROM ts_user_login WHERE 1 $valid_user";
   ...
   <?php include_once('left-sidebar.php'); ?>
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                 <!--  page header -->
                <div class="col-lg-12">
                    <h1 class="page-header">User List <?php //echo $valid_list_qur.$user_role; ?></h1>
                </div>
                 <!-- end  page header -->
            </div>
            <div class="row">
       ...
       <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    <form role="form" id="register-form" action="app/action/front-agent.php" method="post">
                                      <div class="col-lg-12">
									 <div class="col-lg-6">
										...
										<div class="form-group">
                                            <label>Role</label>
                                            <select  name="urole" id="role" class="form-control" onchange="display_hide_group('role','group_block','dept_block');">
                                ...
                                <?php } ?>
									 ...
									 <div class="form-group">
										...
										<div class="form-group">
										 ...
										 <div class="form-group" id="dept_block">
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                        ...
                        <div class="panel-body">
						<div class="panel-heading" style="text-align:right;"><a href="agent-export.php">Download Excel</a></div>
