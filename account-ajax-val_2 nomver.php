...
if(isset($_POST['view_comp_id']))
{
	...
	$query_id='SELECT * FROM ts_account where address = "'.$address.'"';		
	}
   ...
   <div class="modal-dialog modal-lg">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Raise Ticket <?php //echo $back_page_name; ?></h4>
        </div>
       ...
       <div class="row">
				...
				?>
                                ...
                                <?php } ?>
										...
										<?php if($rec_id!='substation'){?>
										<div class="form-group">
                                            <label>Respective Area</label>
                                            
											 <select  name="respective_area" class="form-control" id="respective_area" onchange="display_jedetail(this.value);">
                                                <option value="0" selected disabled>Select Area</option>
                                                <?php foreach($r_je as $value)
				{
				?>
                                                <option value="<?php echo $value['id'];?>"><?php echo $value['je_area'];?></option>
                                <?php } ?>
                                            </select>
                                        </div>
										<?php } else{ ?>
