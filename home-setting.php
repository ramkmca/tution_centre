<?php    
	...
	$project_name    =  trim(addslashes($_POST["project_name"]));
...
?>
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                 <!--  page header -->
                <div class="col-lg-12">
                    <h1 class="page-header">Home Setting</h1>
                </div>
                 <!-- end  page header -->
            </div>
            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <form role="form" id="department-form" action="" method="post" enctype="multipart/form-data">
									 ...
									 <input type="hidden" name="ticket_no" value="<?php echo $ticket_no;?>">
											...
											<input type="text" name="project_name" id="project_name" value="<?php echo $project_name; ?>" class="form-control" >
									 ...
									 <input type="hidden" name="ticket_no" value="<?php echo $ticket_no;?>">
											...
											<img src="upload/<?php echo $image; ?>" width="162" height="60">  
											</div>
