<?php    
	...
	$query="SELECT * FROM ts_admin_login WHERE id='".$admin_id."'"; 
    $r_id = $db->fetchRow($query);	
    if($r_id['pswd']!=$opassword){
	...
	$result = $db->update_query('ts_admin_login', $post_array, $where, $exc);
...
?>
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                 <!--  page header -->
                <div class="col-lg-12">
                    <h1 class="page-header">Edit Profile<?php //print_r($result);?></h1>
                </div>
                 <!-- end  page header -->
            </div>
            <div class="row">
