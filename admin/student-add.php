<?php    
	...
	$mail_content =  trim($r_mail["mail_content"]); 
	 ...
	 $message_email = str_replace("<dob>",$dob,$message);
                                    ...
                                    <form role="form" name="department-form" id="department-form" action="" method="post">
									 ...
									 <div class="form-group">
										   ...
										   <div class="form-group">
                                            ...
                                            <input type="text" name="email" id="email" value="<?php echo $email; ?>" class="form-control"  tabindex="4" placeholder="Email">
											</div>
										...
										?>
											...
											<option value="Activated" <?php if($status=='Activated'){?> selected <?php }?>>Activated</option>
											<option value="Deactivated" <?php if($status=='Deactivated'){?> selected <?php }?>>Deactivated</option>
