...
if(isset($_POST['view_comp_id']))
{
	...
	$remaining_fee = $r_id['fee']-$paid_fee;
	
	 $query_user_list="SELECT * FROM ts_marks WHERE registration_no ='".$r_id['registration_no']."'";
   ...
   <div class="modal-dialog modal-lg">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">View Student Marks <?php //echo $query_add_fee; ?></h4>
        </div>
                            ...
                            <div class="row">
                                    ...
                                    <tbody>
									 <?php foreach($r_user_list as $value)
				                        ...
				                        ?>
									<tr>
									<td><?php echo $value['registration_no'];?></td><td><?php echo $value['subject'];?></td><td><?php echo $value['total_marks'];?></td><td><?php echo $value['obtained_marks'];?></td><td><?php echo $value['date'];?></td>
									</tr>
										<?php } ?>
									 </tbody>
								</table>									 
