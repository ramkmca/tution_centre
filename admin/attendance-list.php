	...
	window.onload = function(){
		...
		new JsDatePick({
            ...
            <div class="row">
                 <!--  page header -->
                <div class="col-lg-12">
                    <h1 class="page-header">Attendance Chart <?php //echo $query_user_list;?></h1>
                </div>
                 <!-- end  page header -->
            </div>
            <div class="row">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading" style="text-align:right;">
                           ...
                           <form name="frm1" id="frm1" method="get">
							 ...
							 <a href="export_attendance.php?registration_no=<?php echo $registration_no;?>&batch_name=<?php echo $batch_id;?>&class_id=<?php echo $class_id;?>&month=<?php echo $month;?>&att_date=<?php echo $att_date;?>&attendance=<?php echo $attendance;?>">Download Excel</a>&nbsp;&nbsp;&nbsp;
                        </div>
...
<script>
function get_batch_list(class_id)
{
