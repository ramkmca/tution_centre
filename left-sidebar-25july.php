            ...
            <div class="sidebar-collapse">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li class="selected">
                     ...
                     <li>
                        <a href="agent-view.php"><i class="fa fa-dashboard fa-fw"></i>Pending Complaints</a>
                    </li>
                     <li>
                        <a href="complaint-solved.php"><i class="fa fa-dashboard fa-fw"></i>Solved Complaints</a>
                    </li>
                      <li>
                        <a href="admin-page.php"><i class="fa fa-dashboard fa-fw"></i>Admin Page</a>
                    </li>
                      <li>
